...
We implement: 
- (see `demo.ipynb`)
- forecasting of the VIX index and SPX realized volatility, and comparison with HAR in the same spirit as in [Hager, Harang, Pelizzari and Tindel](https://arxiv.org/pdf/2603.04525) (see `forecasting.ipynb`), 
