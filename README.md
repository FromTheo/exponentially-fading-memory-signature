...
- characteristic function of linear functionals of the EFM-signature of time-augmented Brownian motion, comparison of RK4, Euler and Predictor-Corrector (PECE) schemes (see `characteristic_function.ipynb`), 
