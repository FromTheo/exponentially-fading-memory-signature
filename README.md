...
- introduction of a model in which the instantaneous volatility is given by a linear combination of elements of the EFM-signature of time-augmented Brownian motion, namely $\sigma_t = \left\langle\bm{\ell}, \widehat{\mathbb{W}}_t^{\bm{\lambda}}\right\rangle$, pricing of $q$-Volatility swaps and computation of IV via Fourier inversion (see `fourier_EFM.ipynb`)
